...
export const products: Product[] = [
  { id: 'g1', name: 'Baked Beans', brand: 'Heinz', category: 'groceries', image: getFoodImg('5000157004676'), prices: [{ shopId: 'tesco', price: 1.40 }, { shopId: 'asda', price: 1.00 }] },
  { id: 'g2', name: 'Mayonnaise', brand: 'Hellmanns', category: 'groceries', image: getFoodImg('8712566353347'), prices: [{ shopId: 'tesco', price: 2.50 }] },
  { id: 'e1', name: 'iPhone 16', brand: 'Apple', category: 'electronics', prices: [{ shopId: 'amazon', price: 789 }, { shopId: 'currys', price: 799 }] }
];
